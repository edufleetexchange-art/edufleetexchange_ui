      ...
      <div className="max-w-4xl mx-auto prose prose-slate">
        ...
        <div className="space-y-8 text-slate-700">
          <section>
            ...
            <p>
              By accessing and using the EduFleet website and application, you accept and agree to be bound by
              and comply with these terms and conditions. If you do not agree to abide by the above, please do
          ...
          <section>
            ...
            <p>
              ...
              on EduFleet for personal, non-commercial transitory viewing only. This is the grant of a license,
          ...
          <section>
            ...
            <p>
              In no event shall EduFleet or its suppliers be liable for any damages (including, without
              limitation, damages for loss of data or profit, or due to business interruption) arising out of
              the use or inability to use the materials on EduFleet, even if EduFleet or an authorized
          ...
          <section>
            ...
            <p>
              ...
              EduFleet does not warrant that any of the materials on its website are accurate, complete, or
              current. EduFleet may make changes to the materials contained on its website at any time without
              notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              EduFleet has not reviewed all of the sites linked to its website and is not responsible for the
              contents of any such linked site. The inclusion of any link does not imply endorsement by EduFleet
          ...
          <section>
            ...
            <p>
              EduFleet may revise these terms of service for its website at any time without notice. By using
